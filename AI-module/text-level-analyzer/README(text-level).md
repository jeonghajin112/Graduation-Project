...
| 위치 참조 / 모호한 참조 | 구체적 이름 사용 ("위의 버튼" → "'제출' 버튼") | KWCAG 5.3.3 명확한 지시사항 제공 |
| 링크 텍스트 길이 초과 | 목적지를 간결하게, 부가 설명은 링크 밖으로 | KWCAG 6.4.3 적절한 링크 텍스트 |
| 버튼 텍스트 길이 초과 | 동작을 2~4단어로 표현 | KWCAG 6.4.3 적절한 링크 텍스트 |
| form_guide·label 길이 초과 | 자세한 설명은 별도 안내 텍스트로 분리 | KWCAG 7.3.2 레이블 제공 |
| heading 길이 초과 | 제목을 간결하게 요약 | KWCAG 6.4.2 제목 제공 |
...
| 저장 항목 | 내용 | 담당 기능 |
|---|---|---|
| WCAG 3.1.5 읽기 수준 | 문장의 인지적 난이도 | Jo(2016) 이독성 공식 |
